...
//   return (
//     <View style={{ marginBottom: 8, spaceY: 4 }}>
...
//         )}
//       </View>
//       <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 15,marginVertical:5 }}>
//         {data.map((item, index) => (
...
//               />
//               {/* The second Image tag here seems redundant, so it's removed */}
//               <Text style={{ color: 'rgba(229, 231, 235, 1)', marginLeft: 12 }}>
//                 {
  ...
  return (
    <View style={{ marginBottom: 8, marginTop: 4 }}>
      ...
      <FlatList
        ...
        contentContainerStyle={{ paddingHorizontal: 15, marginVertical: 5 }}
        data={filteredData}
